"""
Django settings for cloudmaster project.
...
SECRET_KEY = 'django-insecure-9&s4h0qt9mrk#s=m7n%j+a2&9o%n)uiwih94nrxjv2e)%l$z^c'
...
WSGI_APPLICATION = 'cloudmaster.wsgi.application'
